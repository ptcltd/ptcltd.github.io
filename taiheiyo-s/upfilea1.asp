...
sub upload_0()    '使用化境无组件上传类
	...
	for each formName in upload.file '列出所有上传了的文件
		...
		response.write "<div align='center'><img src='" & filename & "' width='100' height='100'></div>"
		response.write "<script>"
		response.write "parent.myform.smallpic.value='"&filename&"';"
		'response.write "parent.myform.UploadFiles.value='"&filename&"';"
		response.write "</script>"
		set file=nothing
	next
	set upload=nothing
