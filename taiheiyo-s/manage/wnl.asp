...
<table cellpadding=3 cellspacing=1 align=center class=tableborder1><tr><th valign=middle colspan=2 align=center height=25><b>万年历</b></td></tr><tr><td valign=middle class=tablebody1 height=100><CENTER>
...
<BODY bgColor=#ffffff leftMargin=0 onload=initial() topMargin=0>
<CENTER></CENTER>
<CENTER>
<TABLE border=1 borderColor=#0099cc borderColorDark=#0099cc 
borderColorLight=#0099cc cellPadding=15 cellSpacing=0 width=450>
  <TBODY>
  <TR>
    <TD height=56>
      <DIV align=center>
...
function drawCld(SY,SM) {
   ...
   GZ.innerHTML = '农历' + cyclical(SY-1900+36) + '年 &nbsp;&nbsp;【'+Animals[(SY-4)%12]+'】';
...
function mOvr(v) {
   ...
   if(sObj.innerHTML!='') {
      ...
      if(cld[d].solarTerms == '' && cld[d].solarFestival == '' && cld[d].lunarFestival == '')
         ...
         festival = '<TABLE WIDTH=100% BORDER=0 CELLPADDING=2 CELLSPACING=0 BGCOLOR="#33CCFF"><TR><TD>'+
         '<FONT COLOR="#000000" STYLE="font-size:9pt;">'+cld[d].solarTerms + ' ' + cld[d].solarFestival + ' ' + cld[d].lunarFestival+'</FONT></TD>'+
         '</TR></TABLE>';

      s= '<TABLE WIDTH="130" BORDER=0 CELLPADDING="2" CELLSPACING=0 BGCOLOR="#0980B3"><TR><TD>' +
         '<TABLE WIDTH=100% BORDER=0 CELLPADDING=0 CELLSPACING=0><TR><TD ALIGN="right"><FONT COLOR="#ffffff" STYLE="font-size:9pt;">'+
         cld[d].sYear+' 年 '+cld[d].sMonth+' 月 '+cld[d].sDay+' 日<br>星期'+cld[d].week+'<br>'+
         '<font color="ffffff">农历'+(cld[d].isLeap?'闰 ':' ')+cld[d].lMonth+' 月 '+cld[d].lDay+' 日</font><br>'+
...
<BODY vLink=#0980b3 aLink=#0980b3 link=#0980b3 bgColor=#e7f7fe onload=initial()>
<SCRIPT language=JavaScript><!--
...
<DIV align=center>
<CENTER>
<TABLE cellSpacing=0 cellPadding=0 width=780 bgColor=#0980b3 border=0>
  <TBODY>
  <TR>
...
<TABLE width=780>
  <TBODY>
  <TR>
    <TD vAlign=top align=middle width=208 bgColor=#ffffff><FONT color=0980b3 
      size=2>
      <SCRIPT language=JavaScript>
...
document.write(date)
      ...
      style="FONT-SIZE: 120pt; COLOR: #13b0f4; FONT-FAMILY: Webdings">&ucirc;</FONT><BR><FONT 
      id=CITY 
      style="FONT-SIZE: 9pt; WIDTH: 150px; COLOR: #0980b3; FONT-FAMILY: '宋体'"></FONT></P></TD>
    <TD align=middle width=536>
      <DIV  style="Z-INDEX: -1; POSITION: absolute;"><FONT id=YMBG 
      style="FONT-SIZE: 100pt; COLOR: white; FONT-FAMILY: 'Arial Black'">&nbsp;0000 
      &nbsp;JUN</FONT>
      ...
      <TABLE border=0>
        <TBODY>
        <TR>
          <TD bgColor=#0980b3 colSpan=7><FONT style="FONT-SIZE: 9pt" 
               ...
               for(j=0;j<7;j++) {        
                  ...
                  if(j == 6)        
                     if(i%2==1) document.write(' color=red')        
                        else document.write(' color=13B0F4')        
    ...
    <TD vAlign=top align=middle width=214 
      bgColor=#ffffff><BR><BR><BR><BR><BUTTON style="FONT-SIZE: 9pt" 
      onclick="pushBtm('YU')">年↑</BUTTON><BR><BUTTON style="FONT-SIZE: 9pt" 
...
</TD></TR></TBODY></TABLE></CENTER></DIV></FORM></CENTER>
