...
rs.close
set rs=nothing
response.Write("<script>alert('success!');window.location='manage_linkjp.asp';</script>")
end if
...
<table width="670" border="0" align="center" cellpadding="0" cellspacing="1" bgcolor="#CCCCCC">
  <form name="myform" method="post" action="manage_linkjp.asp?action=edit">
  <tr>
    <td height="25" colspan="2" align="center" valign="middle" bgcolor="#FFFFFF"><span class="STYLE3"> ‰ïŽÐ‰ˆŠv</span></td>
    </tr>
  ...
  <tr>
    ...
    <td width="537" height="200" align="left" valign="middle" bgcolor="#f1f1f1"><script language="JavaScript">
	  ...
	  <input name="jp_Content" type="hidden" id="jp_Content" value="<%=Server.HTMLEncode(rs("jp_link"))%>"></td>
  </tr>
