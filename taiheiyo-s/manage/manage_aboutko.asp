...
rs.close
set rs=nothing
response.Write("<script>alert('success!');window.location='manage_aboutko.asp';</script>")
end if
...
<table width="670" border="0" align="center" cellpadding="0" cellspacing="1" bgcolor="#CCCCCC">
  ...
  <tr>
    ...
    <td width="537" height="200" align="left" valign="middle" bgcolor="#f1f1f1"><script language="JavaScript">
		   document.write ('<IFRAME ID="content3" src="editor/ewebeditor.asp?id=ko_content&style=edragon" frameborder="0" scrolling="no" width="100%" height="400"></IFRAME>')       
