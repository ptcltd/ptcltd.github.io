                  ...
                  <td height="300" align="center" valign="top"><table width="98%" border="0" cellspacing="0" cellpadding="8">
                    <tr>
                      <td align="center" style="line-height:25px"><table width="90%" border="0" cellspacing="0" cellpadding="0">
                        ...
                        <tr>
                          <td align="left" valign="top" style="line-height:22px; font-size:12px"><strong>調査プロダクト</strong></td>
                        </tr>
                        <tr>
                        ...
                        <tr>
                          <td align="left" valign="top" style="line-height:22px; font-size:12px">調査の結果 <br>
                              <%
...
%>
                              <table  border="0" align="center" cellpadding="10" cellspacing="0" style="border-collapse:collapse;font-size:12px">
                                ...
                                <tr>
                                  <td height="20" align="center"><a href="search.asp?currentpage=1&SearchStringMain=<%=SearchStringMain%>" class="hei1">トップ&nbsp;</a>
                                      <%if nowpage=1 then%>
                                    前ページ
                                    <%else%>
                                    <a href="search.asp?currentpage=<%=nowpage-1%>&SearchStringMain=<%=SearchStringMain%>" class="hei1">前ページ</a>
                                    <%end if%>
                                    &nbsp;/&nbsp;
                                    <%if cint(nowpage)=rs.pagecount then%>
                                    次ページ
                                    <%else%>
                                    <a href="search.asp?currentpage=<%=nowpage+1%>&SearchStringMain=<%=SearchStringMain%>" class="hei1">次ページ</a>
                                    <%end if%>
                                    &nbsp;&nbsp;<a href="search.asp?currentpage=<%=rs.pagecount%>&SearchStringMain=<%=SearchStringMain%>" class="hei1">最後</a></td>
                                </tr>
                              </table>
                            <%
		  end if
